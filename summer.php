...
<head>
        ...
        <link rel="stylesheet" href="/css/summer.css?14">
    ...
    <body class="overflow_y">
        ...
        <main>
            <section id = "summer_block">
                <h1 class = "section_header">Проведите лето вместе с ProGame!</h1>
                <div class = "flex">
                    <a href = "it_kanikuli.php">
                        <div class = "circle_block flex">
                            <div class = "circle flex" id = "holidays">
                                <img id = "s_boy" src = "images/summer/menu/3.png">
                                <img id = "s_girl" src = "images/summer/menu/2.png">
                                <h1 class = "circle_text" style="color: #FFCF97;   -webkit-text-stroke-color: #CB3100;">IT-каникулы</h1>
                            </div>
                            <p class = "description_text">От 8 до 14 лет<br>2 недели / с 9.00 до 18.00</p>
                        </div>
                    </a>
                    <a href = "it_itnensive.php">
                        <div class = "circle_block flex">
                            <div class = "circle flex" id = "intensive">
                                <img id = "s_comp" src = "images/summer/menu/1.png">
                                <h1 class = "circle_text" style="color: #9ECE6F;   -webkit-text-stroke-color: #274906;">IT-интенсивы</h1>
                            </div>
                            <p class = "description_text">От 8 до 17 лет <br> 5 дней по 3,5 часа (ежедневно)</p>
                        </div>
                    </a>
                    <a href = "master_class.php">
                        <div class = "circle_block flex">
                            <div class = "circle flex" id = "mk">
                                <img id = "s_comp_2" src = "images/summer/menu/5.png">
                                <img id = "s_tablet"src = "images/summer/menu/4.png">
                                <h1 class = "circle_text" style="color: #94B9FF;   -webkit-text-stroke-color: #0B5C76;">Мастер-классы</h1>
                            </div>
                            <p class = "description_text">От 6 до 16 лет <br> 1 день / 3 часа</p>
                        </div>
                    </a>
                </div>
            </section>
