...
<head>
    ...
    <body class="overflow_y">
        ...
        <main>
            <section class = "flex" id = "photo_gallery">
                <h1 class = "section_header">Галерея</h1>
                <div class = "flex">
                    <div class = " flex double_photo">
                        <img class = "photo" src = '/images/gallery/2.jpg'>
                        <img class = "photo" src = '/images/gallery/3.jpg'>
                    </div>
                    <img class = "photo one_photo" src = '/images/gallery/1.jpg'>
                    <div class = "flex double_photo">
                        <img class = "photo" src = '/images/gallery/4.jpg'>
                        <img class = "photo" src = '/images/gallery/8.jpg'>
                    </div>
                    <div class = " flex double_photo">
                        <img class = "photo" src = '/images/gallery/9.jpg'>
                        <img class = "photo" src= '/images/gallery/15.jpg'>
                    </div>
                    <div class = " flex double_photo">
                        <img class = "photo" src = '/images/gallery/16.jpg'>
                        <img class = "photo" src = '/images/gallery/14.jpg'>
                    </div>
                    <img class = "photo one_photo" src = '/images/gallery/6.jpg'>
                    <img class = "photo one_photo" src = '/images/gallery/10.jpg'>
                    <div class = " flex double_photo">
                        <img class = "photo" src = '/images/gallery/12.jpg'>
                        <img class = "photo" src = '/images/gallery/5.jpg'>
                    </div>
                    <div id = "last_photo" class = " flex double_photo">
                        <img class = "photo" src = '/images/gallery/13.jpg'>
                        <img class = "photo" src = '/images/gallery/11.jpg'>
                    </div>
                    <img class = "photo horizontal" src = '/images/gallery/7.jpg'>
                </div>
            </section>


            <section id = "start">
                <img id = "dog" src = "/images/corgy.webp">
