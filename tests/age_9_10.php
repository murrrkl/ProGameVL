<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="/css/tests/age_9_10.css">
        <script defer src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
        <script defer src="/js/maska-nomera.js"></script>
        <script defer src = "/js/tests/age_9_10.js"></script>
            ...
            <section class = "flex" id = "test">
                ...
                <div class = "flex" id = "white_box">
                    <div class="flex" id = "task_1">
                        <h2 class = "test_header">Конфеты - тоже сладость. Чего больше: сладостей или конфет?</h2>
                        <img class = "test_img" id = "1" src = "/images/tests/age_9_10/1.png">
                        <div id = "flex">
                            <img class = "answer" id = "1_1" src = "/images/tests/age_9_10/1_1.png">
                            <img class = "answer" id = "1_2" src = "/images/tests/age_9_10/1_2.png">
                        </div>
                    </div>
                    <div id = "task_2">
                        <div class="flex" style = "flex-direction: column;">
                            <h2 class = "test_header">У Олиной мамы 5 дочек: Вика, Аня, Марта, Кира... Как зовут пятую?</h2>
                            <img class = "test_img" id = "2" src = "/images/tests/age_9_10/2.png">
                            <div id = "flex">
                                <img class = "answer" id = "2_1" src = "/images/tests/age_9_10/2_1.png">
                                <img class = "answer" id = "2_2" src = "/images/tests/age_9_10/2_2.png">
                                <img class = "answer" id = "2_3" src = "/images/tests/age_9_10/2_3.png">
                                <img class = "answer" id = "2_4" src = "/images/tests/age_9_10/2_4.png">
                            </div>
                        </div>
                    </div>
                    <div id = "task_3">
                        <div class="flex" style = "flex-direction: column;">
                            ...
                            <img class = "test_img" id = "3" src = "/images/tests/age_9_10/3.png">
                            <div id = "flex">
                                <img class = "answer" id = "3_1" src = "/images/tests/age_9_10/3_1.png">
                                <img class = "answer" id = "3_2" src = "/images/tests/age_9_10/3_2.png">
                                <img class = "answer" id = "3_3" src = "/images/tests/age_9_10/3_3.png">
                                <img class = "answer" id = "3_4" src = "/images/tests/age_9_10/3_4.png">
                            </div>
                        </div>
                    </div>
                    <div id = "task_4">
                        <div class="flex" style = "flex-direction: column;">
                            <h2 class = "test_header">В отеле 4 этажа. Чем выше этаж, тем больше людей там живёт. На какой этаж чаще всего ездит лифт?</h2>
                            <img class = "test_img" id = "4" src = "/images/tests/age_9_10/4.png">
                            <div id = "flex">
                                <img class = "answer" id = "4_1" src = "/images/tests/age_9_10/4_1.png">
                                <img class = "answer" id = "4_2" src = "/images/tests/age_9_10/4_2.png">
                                <img class = "answer" id = "4_3" src = "/images/tests/age_9_10/4_3.png">
                                <img class = "answer" id = "4_4" src = "/images/tests/age_9_10/4_4.png">
                            </div>
                        </div>
                    </div>
                    <div id = "task_5">
                        <div class="flex" style = "flex-direction: column;">
                            <h2 class = "test_header"></h2>
                            <img class = "test_img" id = "5" src = "/images/tests/age_9_10/5.png">
                            <div id = "flex">
                                <img class = "answer" id = "5_1" src = "/images/tests/age_9_10/5_1.png">
                                <img class = "answer" id = "5_2" src = "/images/tests/age_9_10/5_2.png">
                                <img class = "answer" id = "5_3" src = "/images/tests/age_9_10/5_3.png">
                                <img class = "answer" id = "5_4" src = "/images/tests/age_9_10/5_4.png">
                            </div>
                        </div>
                    </div>
                    <div id = "result_1">
