...
<head>
    ...
    <link rel="stylesheet" href="/css/tests/age_13.css">
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script defer src="/js/maska-nomera.js"></script>
    <script defer src = "/js/tests/age_13.js"></script>
    ...
    <section class = "flex" id = "test">
        ...
        <div class = "flex" id = "white_box">
            <div class="flex" id = "task_1">
                <h2 class = "test_header">Где точек больше, чем концов у двух с половиной палок, но меньше, чем ног у двух бегемотов?</h2>
                <img class = "test_img" id = "1" src = "/images/tests/age_13/1.png">
                <div id = "flex">
                    <img class = "answer" id = "1_1" src = "/images/tests/age_13/1_1.png">
                    <img class = "answer" id = "1_2" src = "/images/tests/age_13/1_2.png">
                    <img class = "answer" id = "1_3" src = "/images/tests/age_13/1_3.png">
                </div>
            </div>
            <div id = "task_2">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">В ящике шкафа лежали пара коричневых и синих носков. Какое наименьшее число носков нужно взять не глядя, чтобы среди них точно была пара одного цвета?</h2>
                    <img class = "test_img" id = "2" src = "/images/tests/age_13/2.png">
                    <div id = "flex">
                        <img class = "answer" id = "2_1" src = "/images/tests/age_13/2_1.png">
                        <img class = "answer" id = "2_2" src = "/images/tests/age_13/2_2.png">
                        <img class = "answer" id = "2_3" src = "/images/tests/age_13/2_3.png">
                        <img class = "answer" id = "2_4" src = "/images/tests/age_13/2_4.png">
                    </div>
                </div>
            </div>
            <div id = "task_3">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Роботов разложили по коробкам по одному, и один остался без коробки. Тогда роботов разложили по 2 и коробка оказалась путой. Сколько роботов?</h2>
                    <img class = "test_img" id = "3" src = "/images/tests/age_13/4.png">
                    <div id = "flex">
                        <img class = "answer" id = "3_1" src = "/images/tests/age_13/3_1.png">
                        <img class = "answer" id = "3_2" src = "/images/tests/age_13/3_2.png">
                        <img class = "answer" id = "3_3" src = "/images/tests/age_13/3_3.png">
                        <img class = "answer" id = "3_4" src = "/images/tests/age_13/3_4.png">
                    </div>
                </div>
            </div>
            <div id = "task_4">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Лифт может перевести не более двух взрослых или не более 4 детей. Какое наибольшее кол-во детей может ехать с одним взрослым?</h2>
                    <img class = "test_img" id = "4" src = "/images/tests/age_13/3.png">
                    <div id = "flex">
                        <img class = "answer" id = "4_1" src = "/images/tests/age_13/4_1.png">
                        <img class = "answer" id = "4_2" src = "/images/tests/age_13/4_2.png">
                        <img class = "answer" id = "4_3" src = "/images/tests/age_13/4_3.png">
                        <img class = "answer" id = "4_4" src = "/images/tests/age_13/4_4.png">
                    </div>
                </div>
            </div>
            <div id = "task_5">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Сколько человек занимаются и футболом, и тенисом?</h2>
                    <img class = "test_img" id = "5" src = "/images/tests/age_13/5.png">
                    <div id = "flex">
                        <img class = "answer" id = "5_1" src = "/images/tests/age_13/5_1.png">
                        <img class = "answer" id = "5_2" src = "/images/tests/age_13/5_2.png">
                        <img class = "answer" id = "5_3" src = "/images/tests/age_13/5_3.png">
                        <img class = "answer" id = "5_4" src = "/images/tests/age_13/5_4.png">
                    </div>
                </div>
            </div>
            <div id = "result_1">
