...
<head>
    ...
    <link rel="stylesheet" href="/css/tests/age_11_12.css">
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script defer src="/js/maska-nomera.js"></script>
    <script defer src = "/js/tests/age_11_12.js"></script>
    ...
    <section class = "flex" id = "test">
        ...
        <div class = "flex" id = "white_box">
            <div class="flex" id = "task_1">
                <h2 class = "test_header">Двое идут в город, а на встречу им идут тоже двое. Сколько всего человек идёт в город?</h2>
                <img class = "test_img" id = "1" src = "/images/tests/age_11_12/1.png">
                <div id = "flex">
                    <img class = "answer" id = "1_1" src = "/images/tests/age_11_12/1_1.png">
                    <img class = "answer" id = "1_2" src = "/images/tests/age_11_12/1_2.png">
                    <img class = "answer" id = "1_3" src = "/images/tests/age_11_12/1_3.png">
                    <img class = "answer" id = "1_4" src = "/images/tests/age_11_12/1_4.png">
                </div>
            </div>
            <div id = "task_2">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Продолжи ряд.</h2>
                    <img class = "test_img" id = "2" src = "/images/tests/age_11_12/2.png">
                    <div id = "flex">
                        <img class = "answer" id = "2_1" src = "/images/tests/age_11_12/2_1.png">
                        <img class = "answer" id = "2_2" src = "/images/tests/age_11_12/2_2.png">
                        <img class = "answer" id = "2_3" src = "/images/tests/age_11_12/2_3.png">
                        <img class = "answer" id = "2_4" src = "/images/tests/age_11_12/2_4.png">
                    </div>
                </div>
            </div>
            <div id = "task_3">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Стас и Олег родные братья. У каждого из них есть две родные сестры. Сколько всего детей в семье?</h2>
                    <img class = "test_img" id = "3" src = "/images/tests/age_11_12/3.png">
                    <div id = "flex">
                        <img class = "answer" id = "3_1" src = "/images/tests/age_11_12/3_1.png">
                        <img class = "answer" id = "3_2" src = "/images/tests/age_11_12/3_2.png">
                        <img class = "answer" id = "3_3" src = "/images/tests/age_11_12/3_3.png">
                        <img class = "answer" id = "3_4" src = "/images/tests/age_11_12/3_4.png">
                    </div>
                </div>
            </div>
            <div id = "task_4">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Выбери номер места, на котором стоит автомобиль?</h2>
                    <img class = "test_img" id = "4" src = "/images/tests/age_11_12/4.png">
                    <div id = "flex">
                        <img class = "answer" id = "4_1" src = "/images/tests/age_11_12/4_1.png">
                        <img class = "answer" id = "4_2" src = "/images/tests/age_11_12/4_2.png">
                        <img class = "answer" id = "4_3" src = "/images/tests/age_11_12/4_3.png">
                        <img class = "answer" id = "4_4" src = "/images/tests/age_11_12/4_4.png">
                    </div>
                </div>
            </div>
            <div id = "task_5">
                <div class="flex" style = "flex-direction: column;">
                    <h2 class = "test_header">Монеты из копилки можно разложить по 2 штуки, или по 3, или по 4. Какое наименьшее количество монет может быть в копилке?</h2>
                    <img class = "test_img" id = "5" src = "/images/tests/age_11_12/5.png">
                    <div id = "flex">
                        <img class = "answer" id = "5_1" src = "/images/tests/age_11_12/5_1.png">
                        <img class = "answer" id = "5_2" src = "/images/tests/age_11_12/5_2.png">
                        <img class = "answer" id = "5_3" src = "/images/tests/age_11_12/5_3.png">
                        <img class = "answer" id = "5_4" src = "/images/tests/age_11_12/5_4.png">
                    </div>
                </div>
            </div>
            <div id = "result_1">
